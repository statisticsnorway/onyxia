...
window.addEventListener("onyxiaready", function () {
    ...
    function decorateServiceCards(root) {
        return __awaiter(this, void 0, void 0, function () {
            var releases;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, onyxia.coreAdapters.onyxiaApi.listHelmReleases()];
                    case 1:
                        releases = _a.sent();
                        (root
                            ? Array.from(root.querySelectorAll("[href^=\"/my-service/\"]"))
                            : Array.from(document.querySelectorAll("[href^=\"/my-service/\"]"))).forEach(function (a) {
                            var name = a.getAttribute("href").replace("/my-service/", "");
                            var rel = releases.find(function (r) { return r.helmReleaseName === name; });
                            if (!rel)
                                return;
                            var group = rel.values["dapla.group"];
                            var card = a.closest(".serviceCard");
                            if (!card || card.dataset.groupDecorated === "true")
                                return;
                            var status = card.querySelector('[class$="timeAndStatusContainer"]');
                            var badge = status.cloneNode(true);
    ...
    var servicesContainer = document.querySelector(".servicesContainer");
